  ...
  <div>
    <div class="dashboard" v-bind:style="{backgroundImage: 'url(' + herbs + ' )' }" v-if="displayMode == 'dashboard'">
      <div class="filter-box">
        <input class="search-input" v-model="searchTerm" placeholder="search by keyword" v-on:keyup="searchRecipes()"
            @focus="$event.target.select()">
        <div class="recipe-tile-box" v-if="searchActive == true">
          <recipe-tile
          ...
          <div class="help-text" v-if="searchActive == false">
          ...
          <div v-if="searchActive == false" class="dash-active-filters">
            <div class="help-text" v-if="selectedTags.length">
      ...
      <div class="dash-img" v-bind:style="{backgroundImage: 'url(' + food + ' )' }"></div>
      <div id="newRecipe" >
        <div class="nice-button" v-on:click="newRecipe()" v-if="currentUser.displayName">
          New Recipe
        </div>
      </div>
      <div class="tab-container" >
        <div class="tab-button" v-if="currentUser.displayName"
